...
ser = serial.Serial("COM5", 115200) #look into whether different baud rates are better. orginally COM3 but hopefully COM4 will work, COM3 being used by platformio I think?
